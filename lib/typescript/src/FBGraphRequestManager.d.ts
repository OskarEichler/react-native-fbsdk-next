 ...
 * @format
 */
import GraphRequest, { GraphRequestCallback } from './FBGraphRequest';
export type Callback = (error?: Record<string, unknown> | null, result?: Record<string, unknown> | null) => void;
